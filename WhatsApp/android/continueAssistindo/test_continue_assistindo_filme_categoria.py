...
class MyTestCase(unittest.TestCase):
    ...
    def test_something(self):
        ...
        categorias.click()
        self.driver.implicitly_wait(10)
        categorias_cinema = self.driver.find_element_by_xpath("/hierarchy/android.widget.FrameLayout/android.widget"
