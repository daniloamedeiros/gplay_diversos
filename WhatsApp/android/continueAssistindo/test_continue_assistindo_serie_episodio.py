...
class MyTestCase(unittest.TestCase):
    ...
    def test_something(self):
        ...
        categorias.click()
        self.driver.implicitly_wait(10)
        categorias_series = self.driver.find_element_by_xpath("/hierarchy/android.widget.FrameLayout/android.widget"
                                                              ...
                                                              "2]/android.view.ViewGroup/android.widget.ImageView")
        ...
        self.driver.swipe(525, 1200, 525, 600)

        primeiro_episodio = self.driver.find_element_by_xpath("/hierarchy/android.widget.FrameLayout/android.widget"
                                                           ".LinearLayout/android.widget.FrameLayout/android.widget"
                                                           ".FrameLayout/android.widget.FrameLayout/android.view"
                                                           ".ViewGroup/android.view.ViewGroup/androidx.viewpager"
                                                           ".widget.ViewPager/android.view.ViewGroup/android.widget"
        ...
        if assistir_ou_continuar == 'Assista':
            ...
            categorias.click()
            self.driver.implicitly_wait(10)
            categorias_series = self.driver.find_element_by_xpath("/hierarchy/android.widget.FrameLayout/android"
                                                                  ".widget.LinearLayout/android.widget.FrameLayout"
                                                                  "/android.widget.FrameLayout/android.widget"
                                                                  ".FrameLayout/android.view.ViewGroup/android.widget"
                                                                  ".FrameLayout["
                                                                  "1]/android.view.ViewGroup/androidx.recyclerview"
